...
def introduction(mo):
    mo.md(r"""
    # A2 Q3 · Estimating Lennard-Jones parameters
    ...
    Complete the two visible function cells and record your results.
...
def student_objective(V_data, lj, np, r_data):
    def squared_residual(sigma, epsilon):
        ...
        for r_i, V_i in zip(r_data, V_data):
            # Add the squared difference between V_i and the model energy to total.
            ...
        return total
