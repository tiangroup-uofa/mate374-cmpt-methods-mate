...
4. Why does the polygon's `float64` error stop improving well before reaching 15 correct decimal digits?
5. In a materials calculation, two total energies may be large while their difference is small. What would you check before trusting the digits in that difference?
