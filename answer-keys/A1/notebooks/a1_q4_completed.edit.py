...
def _(mo):
    mo.md(r"""
    # A1 Q4 · Completed reference: Lennard-Jones clusters

    **Predict:** will four atoms prefer a line, a square, or a tetrahedron?
    Both energy functions are completed. Explore the supplied experiments.
    ...
    Open **Edit code** to inspect the functions. Save your edited notebook
