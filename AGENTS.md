...
- `_quarto.yml` includes the full-site render targets, including seminars. Its pre-render hooks export local notebooks and stage answer PDFs; its post-render hook generates `llms.txt`.
